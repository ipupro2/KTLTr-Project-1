...
//Destroy Meteor in specified position(remove it from console)
//Phá hủy thiên thạch ở vị trí chỉ định(xóa nó khỏi màn hình console)
...
//Create new meteorite in random position
...
//Di chuyển người chơi bằng các phím
...
void HitPlayer(position playerPosition, position meteoriteLoc[], int &meteoriteCount, int &playerHP);
